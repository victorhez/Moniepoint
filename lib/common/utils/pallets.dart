...
abstract class Pallets {
  static const purple = Color(0xFF6009b3);
  static const purplelight = Color(0xFF914aaa);
  static const purpledark = Color(0xFF5b03b2);
  static const plight = Color(0xFFd11eb0);
  static const whitecolor = Color(0xFFffffff);
  static const backgroundcolor = Color(0xFFFeFeFe);
  static const greytextcolor = Color(0xFF798CA3);
  static const textcolor = Color(0xFF333333);
  static const outlinecolor = Color(0xFFcfcfcf);
  static const surface = Color(0xFFfafafa);
  static const  greycolor=Color(0xffefefef);
  static const  nearwhitegray=Color(0xffefefef);
  static const  miccolor=Color(0xffece2f4);
  static const  whitegray=Color(0xfff3f3f3);
  static const primary = Color(0xFF0E0E0E);
  static const primaryDark = Color(0xFF343434);
  static const darkGrey = Color(0xFF252525);
  static const chatColor = Color(0xFFebebee);
  static const midGrey = Color(0xFF383838);
  static const lighterGrey = Color(0xFF7A8699);
  static const foldercolor = Color(0xFFf7f4fa);
  static const innercolor = Color(0xFF333333);
  static const lightGrey = Color(0xFF5E5E5E);
  static const chipGreyDisabled = Color(0xFFDAD9D9);
  static const errorRed = Color(0xFFAA0606);
  static const bgDark = Color(0xFF0d0d0d);
  static const mildWhite = Color(0xFFE7E7E7);
  ...
  static const secondary = Color(0xFFEEB21A);
